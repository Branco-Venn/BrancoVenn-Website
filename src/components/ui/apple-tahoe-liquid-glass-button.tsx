      ...
      <>
        ...
        <style>{`
          ...
          @media (hover: hover) {
            ...
            .btn-liquid:not(:disabled):hover .btn-liquid-lens-${filterId} {
              background-color: rgba(250, 132, 83, 0.12) !important;
              box-shadow: 
                inset 0 0 0 1.5px rgba(250, 132, 83, 0.6),
                inset 1.8px 3px 0px -2px rgba(255, 255, 255, 0.9), 
                inset -2px -2px 0px -2px rgba(255, 255, 255, 0.8), 
                0 0 30px rgba(250, 132, 83, 0.4);
            }
          }
