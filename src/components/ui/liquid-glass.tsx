...
export const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const content = (
    <div
      className={`relative flex font-semibold overflow-hidden text-current cursor-pointer transition-all duration-700 ${className}`}
      style={glassStyle}
    >
      {/* Glass Layers */}
      <div
      ...
      />
      <div
        className="absolute inset-0 z-20 rounded-inherit overflow-hidden animate-pulse-slow"
        style={{
          boxShadow:
